...
class GetBackups():
    download_what = '/home/{}/kopia_zapasowa/'
    download_where = 'C:\\Users\\{}\\kopie_zapasowe\\{}\\'

    # Paths.
    backup_folder_name = 'kopie_zapasowe'
    backup_folder_path = 'C:\\Users\\{}\\kopie_zapasowe'
    home_folder = 'C:\\Users\\{}'

    # SSH
    ssh_config = 'c:\\Users\\{}\\.ssh\\config'
    ssh_key = 'c:\\Users\\{}\\.ssh\\{}'
    ...
    def create_paths(self, server_user):
        ...
        self.download_what = self.download_what.format(server_user)
    ...
    def backup_folder(self, server_key, server_user, server_ip, folder, download_where):
        print(self.download_folder_command.format(
            server_key,
            server_user,
            server_ip,
            folder,
        ...
        try:
            try:
                ...
                pass
            print(download_folder_command)
            os.system(download_folder_command)
        except Exception as e:
            print('something wrong:', e)

    def backup_linux_to_linux(self, download_what=None, download_where=None, server_key=None, server_ip=None,
                              server_user=None, other_config=None, hostname=None):
        '''
        '''
        self.create_paths(server_user)
        self.create_folders()
...
if __name__ == '__main__':
    Up = GetBackups()
    Up.backup_linux_to_linux(server_key='NEW.pem', server_user='ubuntu', server_ip='52.206.231.89')
